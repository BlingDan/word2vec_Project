...
path = os.getcwd() + "/output/total_weiboComments_spider0508.csv"
path1=os.getcwd() +'/output/title_weiboComments_spider0508.csv'
path2=os.getcwd() + '/output/comment_weiboComments_spider0508.csv'
...
# 设置headers
headers = {
     'cookie':'SUB=_2A25PuHrWDeRhGeBM6FoV8i_LzziIHXVtQwaerDV6PUJbktCOLRbTkW1NROao6FfP26v_KOr8_GtmnloClEIXty_j; SUBP=0033WrSXqPxfM725Ws9jqgMF55529P9D9WWSnllbyXAwiPsHRyIO-pnc5NHD95QceoeRShzpS0BXWs4Dqc_Ii--fi-2Xi-24i--NiKnXi-zci--fiK.piKnci--NiKLWiKnXi--ciK.RiKLsi--fiKnfiKn4i--RiK.7i-i2i--fiKLhi-2Ri--ciKyhiKnNi--fi-z7iK.c; _T_WM=71322364890; WEIBOCN_FROM=1110006030; MLOGIN=1; XSRF-TOKEN=f9d09c; M_WEIBOCN_PARAMS=luicode%3D10000011%26lfid%3D100103type%253D38%2526q%253D%25E8%25A5%25BF%25E5%25AE%2589%2526t%253D%26fid%3D100103type%253D1%2526q%253D%2523%25E4%25B8%258A%25E6%25B5%25B7%25E7%2596%25AB%25E6%2583%2585%2523%26uicode%3D10000011',
     'Referer':'https://m.weibo.cn/search?containerid=100103type%3D1%26q%3D%23%E4%B8%8A%E6%B5%B7%E7%96%AB%E6%83%85%23',
...
def get_title_id(pagestart, pageend):
        for page in range(pagestart, pageend):
            ...
            api_url = 'https://m.weibo.cn/api/container/getIndex?containerid=100103type%3D1%26q%3D%23%E4%B8%8A%E6%B5%B7%E7%96%AB%E6%83%85%23&page_type=searchall&page='+str(page)
            print(api_url)
            logging.captureWarnings(True)
            rep1 = requests.get(url=api_url, headers=headers,verify=False)
